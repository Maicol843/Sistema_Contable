...
function registrarDatos() {
  ...
  document.getElementById('solicitante-tabla').innerHTML = solicitante;
  document.getElementById('direccion-tabla').innerHTML = direccion;
  document.getElementById('remitente-tabla').innerHTML = remitente;
...
function loadTable() {
  ...
  entries.forEach(entry => {
    document.getElementById('solicitante-tabla').innerHTML = entry.solicitante;
    document.getElementById('direccion-tabla').innerHTML = entry.direccion;
    document.getElementById('remitente-tabla').innerHTML = entry.remitente;
  });
}
...
function reestablecerDatos(){
  const entries = JSON.parse(localStorage.getItem('formData')) || [];
  entries.forEach(entry => {
    document.getElementById('solicitante-tabla').innerHTML = '';
