function loadTable() {
    ...
    entries.forEach(entry => {
        document.getElementById('solicitante-tabla') = entry.solicitante;
        document.getElementById('direccion-tabla') = entry.direccion;
        document.getElementById('remitente-tabla') = entry.remitente;
    });
}
